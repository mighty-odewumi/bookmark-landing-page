// import rental from "./card-assets/juice-rental.png";
import laroi from "./card-assets/laroi-juice.png";
import bathroom from "./card-assets/bathroom.svg";
import furniture from "./card-assets/furniture.svg";
import house from "./card-assets/house3-edit1.jpg";
import favorite from "./card-assets/favorite-icon.svg";
      ...
      */}
      ...
      >
        <img
          src={house} 
          alt="image" 
          className="object-fill rounded-t-md h-full hover:translate-x-70"
        />

        <img src={favorite} alt="favorite icon" className="absolute top-4 right-4 w-6"/>
